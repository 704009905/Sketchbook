...
public class Sketchbook {
    ...
    private void registerPayloads(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(EntityDetailScanCompletePayload.TYPE, EntityDetailScanCompletePayload.STREAM_CODEC, EntityDetailScanCompletePayload::handle);
        registrar.playToServer(EntityScanCompletePayload.TYPE, EntityScanCompletePayload.STREAM_CODEC, EntityScanCompletePayload::handle);
        registrar.playToServer(EntityScanListRequestPayload.TYPE, EntityScanListRequestPayload.STREAM_CODEC, EntityScanListRequestPayload::handle);
        registrar.playToServer(EntityScanStatusRequestPayload.TYPE, EntityScanStatusRequestPayload.STREAM_CODEC, EntityScanStatusRequestPayload::handle);
        ...
        registrar.playToClient(EntityScanListSyncPayload.TYPE, EntityScanListSyncPayload.STREAM_CODEC, EntityScanListSyncPayload::handle);
        registrar.playToClient(EntityScanStatusSyncPayload.TYPE, EntityScanStatusSyncPayload.STREAM_CODEC, EntityScanStatusSyncPayload::handle);
